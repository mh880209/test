        ...
        <div class="row">
                ...
                <nav class="work-nav">
                	...
                	<div id="filter" >
	                    <ul id="filters" class="option-set" data-option-key="filter">
	                       ...
	                       <li><a href="myItem.do" class="selected" id="">내 등록 상품 관리</a></li>
	                       <li><a href="myZzim.do" id="">찜한목록</a></li>
	                       <li><a href="myInfo.do" id="">내 정보수정</a></li>
	                       <li><a href="myDrop.do" id="">회원탈퇴</a></li>
            ...
            <div class="span9">
            	...
            	<div class="row">
                	...
                	<section id="projects" style="margin-left: 90px;">
                    	<ul id="thumbs">
								...
								<div style="width: 200px; height: 200px;">
									<div style="width:100%; height: 100%">
			                            	...
			                            	<div style="position: absolute; top:0px; left:176px;">
				                            	<a class="" title="#" href="#">
				                            		<img style="" src="_include/img/cancel.png" alt="">
				                            	</a>
	                             			</div>
			                            	 
			                            	
			                            	<a class="" title="#" href="index.jsp">
			                            		<img style="width:100%; height:80%" src="_include/img/work/thumbs/image-01.jpg" alt="">
			                            	</a>
			                            	
			                            	<p style="margin-bottom: 0px; height:10%;">title</p>
			                            	<p style="margin-bottom: 0px; height:10%;">price</p>
									</div>
                             	</div>
