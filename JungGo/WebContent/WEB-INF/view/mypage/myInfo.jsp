                ...
                <nav class="work-nav">
                	...
                	<div id="filter" >
	                    <ul id="filters" class="option-set" data-option-key="filter">
	                       ...
	                       <li><a href="myInfo.do" class="selected" id="">내 정보수정</a></li>
