                ...
                <nav id="options" class="work-nav">
                	...
                	<div id="filter" >
	                    <ul id="filters" class="option-set" data-option-key="filter">
	                       ...
	                       <li><a href="#filter" data-option-value=".cloth">- 의류용품</a></li>
	                       <li><a href="#filter" data-option-value=".sport">- 레저용품</a></li>
	                       <li><a href="#filter" data-option-value=".appliances">- 가전제품</a></li>
	                    </ul>
                    </div>
                	...
                	<section id="projects">
                    	...
                    	<ul id="thumbs">
                            ...
                            <li class="item-thumbs span2 cloth">
	                            <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="#" href="sell.do?id=cloth"></a>
                                <img src="_include/img/work/thumbs/image-01.jpg" alt="">
                            </li>
                              
                            <li class="item-thumbs span2 sport">
	                            <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="#" href="sell.do?id=sport"></a>
                                <img src="_include/img/work/thumbs/image-02.jpg" alt="">
                            </li>
                            
                            <li class="item-thumbs span2 appliances">
	                            <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="#" href="sell.do?id=appliances"></a>
