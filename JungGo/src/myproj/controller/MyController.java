...
public class MyController {
	...
	public String sell(@RequestParam String id,Model model){
		model.addAttribute("message", id);
        return "sell/sell";
	
	}
	
//	@RequestMapping(value="sell2.do")
//	public String sell(){
//		
//        return "sell/sell";
//	
//	}
	...
	@RequestMapping(value="addrItem.do")
	public void addrItem(){
	...
	@RequestMapping(value="myZzim.do")
	...
	@RequestMapping(value="myDrop.do")
	public String myDrop(){

		return "mypage/myDrop1";
	}  
	
	 
	@RequestMapping(value="myDrop1.do")
	public String myDrop1(){

		return "mypage/myDrop2";
	}
